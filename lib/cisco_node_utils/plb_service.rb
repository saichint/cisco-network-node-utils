...
module Cisco
  # node_utils class for plb_service
  class PlbService < NodeUtil
    attr_reader :name
    ...
    def self.plbs
      hash = {}
      list = []
      services = config_get('plb_service',
                            'all_plbs')
      ...
      list.each do |id|
        hash[id] = PlbService.new(id, false)
      end
      hash
    end
    ...
    def create
      Feature.plb_enable
      config_set('plb_service', 'create', name: @name)
    end

    def destroy
      # the service MUST be shutdown before it can be destroyed
      config_set('plb_service', 'shutdown', name: @name, state: '')
      config_set('plb_service', 'destroy', name: @name)
    end
    ...
    def access_list
      config_get('plb_service', 'access_list', @get_args)
    end
    ...
    def access_list=(val)
      if val.empty?
        ...
        config_set('plb_service', 'access_list', @set_args) unless
        access_list.empty?
      else
        @set_args[:state] = ''
        @set_args[:al] = val
        config_set('plb_service', 'access_list', @set_args)
      end
      set_args_keys_default
    end

    def default_access_list
      config_get_default('plb_service', 'access_list')
    end

    def device_group
      config_get('plb_service', 'device_group', @get_args)
    end
    ...
    def device_group=(val)
      if val.empty?
        ...
        config_set('plb_service', 'device_group', @set_args) unless
        device_group.empty?
      else
        @set_args[:state] = ''
        @set_args[:dg] = val
        config_set('plb_service', 'device_group', @set_args)
      end
      set_args_keys_default
    end

    def default_device_group
      config_get_default('plb_service', 'device_group')
    end

    def exclude_access_list
      config_get('plb_service', 'exclude_access_list', @get_args)
    end
    ...
    def exclude_access_list=(val)
      if val.empty?
        ...
        config_set('plb_service', 'exclude_access_list', @set_args) unless
        exclude_access_list.empty?
      else
        @set_args[:state] = ''
        @set_args[:al] = val
        config_set('plb_service', 'exclude_access_list', @set_args)
      end
      set_args_keys_default
    end

    def default_exclude_access_list
      config_get_default('plb_service', 'exclude_access_list')
    end

    def fail_action
      config_get('plb_service', 'fail_action', @get_args)
    end

    def fail_action=(state)
      no_cmd = (state ? '' : 'no')
      @set_args[:state] = no_cmd
      config_set('plb_service', 'fail_action', @set_args)
      set_args_keys_default
    end

    def default_fail_action
      config_get_default('plb_service', 'fail_action')
    end
    ...
    def ingress_interface_cleanup
      ...
      cur_list.each do |intf, _next_hop|
        ...
        config_set('plb_service', 'ingress_interface', @set_args)
      end
    end
    ...
    def default_ingress_interface
      config_get_default('plb_service', 'ingress_interface')
    end
    ...
    def lb_get
      str = config_get('plb_service', 'load_balance', @get_args)
    ...
    def default_load_bal_buckets
      config_get_default('plb_service', 'load_bal_buckets')
    end
    ...
    def default_load_bal_mask_pos
      config_get_default('plb_service', 'load_bal_mask_pos')
    end
    ...
    def default_load_bal_method_bundle_hash
      config_get_default('plb_service', 'load_bal_method_bundle_hash')
    end
    ...
    def default_load_bal_method_bundle_select
      config_get_default('plb_service', 'load_bal_method_bundle_select')
    end
    ...
    def default_load_bal_method_end_port
      config_get_default('plb_service', 'load_bal_method_end_port')
    end
    ...
    def default_load_bal_method_start_port
      config_get_default('plb_service', 'load_bal_method_start_port')
    end
    ...
    def default_load_bal_method_proto
      config_get_default('plb_service', 'load_bal_method_proto')
    end
    ...
    def default_load_bal_enable
      config_get_default('plb_service', 'load_bal_enable')
    end
    ...
    def load_balance_set(attrs)
      ...
      @get_args = @set_args
      config_set('plb_service', 'load_balance', @set_args)
      set_args_keys_default
    end

    def nat_destination
      config_get('plb_service', 'nat_destination', @get_args)
    end

    def nat_destination=(state)
      no_cmd = (state ? '' : 'no')
      @set_args[:state] = no_cmd
      config_set('plb_service', 'nat_destination', @set_args)
      set_args_keys_default
    end

    def default_nat_destination
      config_get_default('plb_service', 'nat_destination')
    end

    def peer_local
      config_get('plb_service', 'peer_local', @get_args)
    end
    ...
    def peer_local=(val)
      if val.empty?
        ...
        config_set('plb_service', 'peer_local', @set_args) unless
        current_peer_local.nil? || current_peer_local.empty?
      else
        @set_args[:state] = ''
        @set_args[:service] = val
        config_set('plb_service', 'peer_local', @set_args)
      end
      set_args_keys_default
    end
    ...
    # when it is not shut
    def shutdown
      config_get('plb_service', 'shutdown', @get_args)
    end

    def shutdown=(state)
      no_cmd = (state ? '' : 'no')
      @set_args[:state] = no_cmd
      config_set('plb_service', 'shutdown', @set_args)
      set_args_keys_default
    end

    def default_shutdown
      config_get_default('plb_service', 'shutdown')
    end

    def virtual_ip
      list = config_get('plb_service', 'virtual_ip', @get_args)
      list.each do |line|
        line['l3-device-group'] = 'device-group' if
          line.include?('l3-device-group')
      end
      list
    end
    ...
    def virtual_ip=(values)
      ...
      list.each do |line|
        ...
        config_set('plb_service', 'virtual_ip', @set_args)
      end
      @set_args[:state] = ''
    ...
    def default_virtual_ip
      config_get_default('plb_service', 'virtual_ip')
    end
  end  # Class
end    # Module
